...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {showSidebar && (
        <div className="xl:w-400 w-20 flex flex-col justify-start mb-10 border-gray-100 xl:border-0 p-3">
          ...
          {/* {!userProfile && (
            <div className="px-2 py-4 hidden xl:block">
              <p className="text-gray-400">Log in to like, share and comment on videos. </p>
              <div className="pr-4">
                <GoogleLogin
                  clientId="" 
                  render={(renderProps) => (
